...
public class BreezyEntities {
    ...
    public static final RegistryObject<EntityType<HotAirBalloonEntity>> HOT_AIR_BALLOON = create("hot_air_balloon", EntityType.Builder.of(HotAirBalloonEntity::new, MobCategory.MISC).sized(1.2f, 4.75f));
