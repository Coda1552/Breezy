package coda.breezy.networking.packet;
...
public class S2CPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> ItemProperties.register(BreezyItems.GUST_GAUGE.get(), new ResourceLocation(Breezy.MOD_ID, "angle"), new ClampedItemPropertyFunction() {
